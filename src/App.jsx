  ...
  return (
    <>
      ...
      {locDiscModal && (() => {
        ...
        const mValid  = r.type==='cut' ? (r.missingType && r.missingType!=='' && mTotCut(r)===mNeeded(r) && (r.missingType!=='known' || (r.missingBed&&r.missingBed!==''&&(r.missingBed!=='other'||(r.missingNote||'').trim()!=='')))) : (r.expM!==''&&r.expY!=='')
